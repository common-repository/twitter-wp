<?php
/*
Plugin Name: Twitter WP
Plugin URI: http://plugins.sonicity.eu/twitter-plugin/
...
add_action('admin_menu', 'twitter_add_pages');
...
if (!function_exists("twitter_refresh")) {
...
function twitter_add_pages() {
    add_options_page('Twitter', 'Twitter', 'administrator', 'twitter', 'twitter_options_page');
}

// twitter_options_page() displays the page content for the Test Options submenu
...
<p><?php _e("Number of Tweets to Show:", 'mt_trans_domain' ); ?> 
<input type="text" name="<?php echo $data_field_name_2; ?>" value="<?php echo $opt_val_2; ?>" size="3">
</p><hr />

<p><?php _e("How long should the cache last for? Recommended 30, at least.", 'mt_trans_domain' ); ?> 
...
<input type="radio" name="<?php echo $data_field_name_10; ?>" value="Day" <?php echo $change71; ?>>Da
</p><hr />

<p><?php _e("Display your profile image?", 'mt_trans_domain' ); ?> 
...
<p><?php _e("Color of Text (In Hex):", 'mt_trans_domain' ); ?> 
...
$listed=$xmldata->listed_count . ' Listed';
$favourites=$xmldata->favourites_count . ' Favorites';
...
$widget_title=str_replace("%listed%", $listed, $widget_title);
$widget_title=str_replace("%favorites%", $favourites, $widget_title);
...
if ($enablegravatar=="" || $enablegravatar=="Yes") { $twitterdisp .= '<img src="'.$gravatar.'" alt="'.$optiontwitter.'" '.$extracode.' align="left" style="padding: 3px;"/>'; }
  ...
  $twitterdisp .= $widget_title.'</a>';

$twitterdisp .= $after_title.$breaky;
...
$twitterdisp .= '<a href="http://twitter.com/share" class="twitter-share-button" data-count="none">Tweet</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>';

if ($supportplugin=="Yes" || $supportplugin=="") {
$twitterdisp .= '<p style="color:#'.$twittercolour.'; font-size:x-small">Twitter Plugin made by <a href="http://www.xeromi.net">Web Hosting</a></p>';
}
...
register_sidebar_widget("Twitter WP", "show_twitter");
}
